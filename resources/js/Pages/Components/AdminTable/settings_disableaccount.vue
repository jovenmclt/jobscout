<template>
    <div class="d-flex justify-content-between mb-3">
         <div class="text-start mb-3 mt-2">
                <h6 class="fw-normal text-secondary">List of disabled account</h6>
            </div>
...
export default {
    ...
    computed:{
        list_filter(){
            return this.all_user.data.filter(data => data.status == '0').filter(filterdata => {

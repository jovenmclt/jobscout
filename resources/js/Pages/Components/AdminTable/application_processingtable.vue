<template>
    <div class="d-flex justify-content-between mb-3">
         <div class="text-start mb-3 mt-2">
                <h6 class="fw-normal text-secondary">List of processing applicant's</h6>
            </div>
...
export default {
    name: 'application_processingtable',
    ...
    computed:{
        list_filter(){
            return this.application_list.data.filter(processdata =>  processdata.status.includes('Processing')).filter(filterdata => {

<template>
    <div class="d-flex justify-content-between mb-3">
         <div class="text-start mb-3 mt-2">
                <h6 class="fw-normal text-secondary">List of hired applicant's</h6>
            </div>
...
export default {
    ...
    computed:{
        list_filter(){
            return this.application_list.data.filter(processdata =>  processdata.status.includes('Hired')).filter(filterdata => {

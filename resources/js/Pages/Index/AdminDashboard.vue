                    ...
                    <div class="row justify-content-start">
                            ...
                            <div class="py-3 px-3 bg-white rounded shadow-sm d-flex justify-content-between mt-3 mb-4 border" style="width: 350px;">
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="text-start mt-1">
                                        ...
                                        <p class="fw-normal text-secondary mb-0">Admin user</p>
                                    </div>
                                </div>
                                <div class="text-start mt-1">
                                    <a href="#">
                        ...
                        <div class="col-lg-4">
                            <div class="bg-white rounded shadow-sm border">
                                ...
                                <canvas id="jobschart" class="bg-transparent" style="width: 100%; height: 40px; "></canvas>
                            </div>
                        </div>
    ...
    methods:{
        ...
        ApplicantsMonthly(){
            ...
            const data = {
                ...
                datasets: [{
                    label: 'Applications',
                    data: [154, 156, 157, 158, 159, 156, 157, 157, 158, 159, 158, 161],
                    fill: true,
                    borderColor: '#D22C90',
        ...
        TotalMembers(){
            ...
            const data = {
                ...
                datasets: [{
                    label: 'Members',
                    data: [254, 256, 167, 148, 119, 256, 457, 257, 258, 119, 148, 171],
                    fill: true,
                    borderColor: '#F59E0B',
